...
SELECT 'fanjoy_customers_data' as table_name
  , count(*) as num_rows
  , to_char(MAX(created_at) AT TIME ZONE 'PST','YYYY-MM-DD HH24:MI:SS') as last_updated
FROM public.fanjoy_customers_data
...
SELECT 'fanjoy_lineitems_data' as table_name
  , count(*) as num_rows
  , to_char(CURRENT_DATE AT TIME ZONE 'PST','YYYY-MM-DD HH24:MI:SS') as last_updated
FROM public.fanjoy_lineitems_data
...
SELECT 'ga_event_data' as table_name
  , count(*) as num_rows
  , to_char(MAX(date) AT TIME ZONE 'PST','YYYY-MM-DD HH24:MI:SS') as last_updated
FROM public.ga_event_data
...
SELECT 'klaviyo_orders_data' as table_name
  , count(*) as num_rows
  , to_char(MAX(order_datetime)::timestamp,'YYYY-MM-DD HH24:MI:SS') as last_updated
FROM klaviyo_orders_data
...
SELECT 'klaviyo_profiles_data' as table_name
  , count(*) as num_rows
  , to_char(MAX(last_import) AT TIME ZONE 'PST','YYYY-MM-DD HH24:MI:SS') as last_updated
...
SELECT 'surveys_sent' as table_name
  , count(*) as num_rows
  , to_char(MAX(sent_on) AT TIME ZONE 'PST','YYYY-MM-DD HH24:MI:SS') as last_updated
FROM survey.surveys_sent
UNION
...
SELECT 'facebook_post_data' as table_name
  , count(*) as num_rows
  , to_char(MAX(created_at)::TIMESTAMP AT TIME ZONE 'PST','YYYY-MM-DD HH24:MI:SS') as last_updated
FROM unicorn_social_media.facebook_post_data
UNION
